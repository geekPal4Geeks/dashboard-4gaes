        ...
        <Masonry columns={{ xs: 1, sm: 2, md: 3 }} spacing={3}>
          ...
          <Card sx={{ width: 350, minHeight: 175, boxShadow: 3, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <CardActions sx={{ pt: 0, mt: '10px' }}>
              <Button onClick={() => navigate('/courses')}>Supervisar curso →</Button>
            </CardActions>
          </Card>
          <Card sx={{ width: 350, minHeight: 175, boxShadow: 3, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <CardContent sx={{ pb: 0, flexGrow: 1 }}>
            ...
            <CardActions sx={{ pt: 0, mt: '10px' }}>
              <Button onClick={() => navigate('/mentorships')} color="secondary">Registrar mentoría →</Button>
            </CardActions>
          </Card>
          <Card sx={{ width: 350, minHeight: 175, boxShadow: 3, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <CardContent sx={{ pb: 0, flexGrow: 1 }}>
            ...
            <CardActions sx={{ pt: 0, mt: '10px' }}>
              <Button onClick={() => navigate('/students')} size="small">Buscar estudiante →</Button>
            </CardActions>
          </Card>
          {canSeeManagement && (
            <Card sx={{ width: 350, minHeight: 175, boxShadow: 3, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <CardActions sx={{ pt: 0, mt: '10px' }}>
                <Button onClick={() => navigate('/courses-management')} sx={{ color: '#2ecc71' }}>Ir a gestión de cohortes →</Button>
              </CardActions>
            </Card>
          )}
          {canSeeProfile && (
            <Card sx={{ width: 350, minHeight: 175, boxShadow: 3, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              ...
              <CardActions sx={{ pt: 0, mt: '10px' }}>
                <Button onClick={() => navigate('/profile')} color="secondary">Ver tu perfil →</Button>
              </CardActions>
            </Card>
          )}
          {canSeeImpersonation && (
            <Card sx={{ width: 350, minHeight: 175, boxShadow: 3, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
              <CardContent sx={{ pb: 0, flexGrow: 1 }}>
                <Box display="flex" alignItems="center" mb={1}>
                  <Visibility color="action" sx={{ fontSize: 36, mr: 1 }} />
                  <Typography variant="h6" fontWeight={700}>Impersonar mentor</Typography>
                </Box>
                <Typography variant="body2" color="text.secondary" mb={1}>
                  Busca un mentor o asistente por correo para revisar su perfil en modo solo lectura.
                </Typography>
              </CardContent>
              <CardActions sx={{ pt: 0, mt: '10px' }}>
                <Button onClick={() => navigate('/profile')}>Abrir vista read-only →</Button>
              </CardActions>
            </Card>
          )}
        </Masonry>
